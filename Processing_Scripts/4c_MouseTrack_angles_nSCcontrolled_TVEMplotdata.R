...
#get file list
filepaths_FinalMods = list.files(path = "./Data/TVEM_FinalModels_nSCcontrol_Child/", pattern="*plot_data.sas7bdat", full.names=TRUE)
filenames_FinalMods = list.files(path = "./Data/TVEM_FinalModels_nSCcontrol_Child/", pattern="*plot_data.sas7bdat", full.names=FALSE)
...
#####################################
#### export data ####
write.csv(FinalMods_plotData, 'Data/Databases/TVEM_FinalMods_nSCcontrolled_PlotData.csv', row.names = FALSE)
